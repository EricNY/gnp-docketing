class PatentsController < ApplicationController
  ...
  def new
    @patent = Patent.new
    @status_options = ["Provisional Application", "Notice to File Missing Parts", "Restriction requirement", 
      "Office action", "Extension 1", "Extension 2", "Extension 3", "NOA", "Issued", "Design Patent", 
      "Utility Patent"]
  end
  ...
  private
    ...
    def patent_params
      params.require(:patent).permit(:owner, :natureOfInvention, :country, :filingDate, :issueDate, :applicationNumber, :patentNumber, :status, :statusDate, :dueDate, :secondDueDate, :thirdDueDate, :comments)
    end
end
