class TrademarksController < ApplicationController
  ...
  def new
    ...
    @status_options = ["Pending", "Published", "NOA", "Notice of Abandonment", "Office Action", "Extenstion 1", "Extenstion 2", 
      "Extenstion 3", "Extenstion 4", "Extenstion 5", "Registration Date"]
  end
  ...
  private
    ...
    def trademark_params
      params.require(:trademark).permit(:owner, :mark, :country, :ic, :goodsAndServices, :filingDate, :registrationDate, :applicationNumber, :registrationNumber, :status, :statusDate, :dueDate, :secondDueDate, :comments)
    end
end
